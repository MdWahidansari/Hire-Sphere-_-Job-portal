// Base API endpoints for different modules in the application
...
// Company-related API endpoint
export const COMPANY_API_END_PONT = "https://hire-sphere-job-portal-6.onrender.com/api/v1/company";
